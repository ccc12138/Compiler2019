...
static const yytype_uint16 yyrline[] =
{
     ...
     130,   134,   135,   136,   141,   142,   143,   148,   149,   151,
     155,   159,   164,   168,   171,   175,   179,   183,   187,   190,
     194,   196,   200,   204,   211,   212,   214,   215,   219,   224,
     225,   227,   228,   232,   233,   234,   235,   236,   237,   238,
     239,   240,   241,   242,   243,   244,   245,   246,   247,   248,
     249,   250,   254,   258,   262,   267,   268
};
#endif
...
#line 88 "./syntax.y"
    {
												(yyval.type_node)=InitNode("ExtDef",(yyloc).first_line);
												InsertNode((yyval.type_node),2,(yyvsp[(1) - (3)].type_node),(yyvsp[(2) - (3)].type_node));
}
    break;
...
/* Line 1806 of yacc.c  */
#line 127 "./syntax.y"
    {(yyval.type_node)=InitNode("OptTage",(yyloc).first_line);InsertNode((yyval.type_node),1,(yyvsp[(1) - (1)].type_node));}
    break;
